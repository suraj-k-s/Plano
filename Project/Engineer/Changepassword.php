...
<form id="form1" name="form1" method="post" action="">
  <table align="center" width="431" border="1">
    <tr>
    ...
    <tr>
      ...
      <input type="password" name="txt_newpass" id="txt_newpass" pattern="(?=.\d)(?=.[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"  required="required" /></td>
    </tr>
    <tr>
